...
Route::group(['middleware'=>'auth'],function(){
		...
		Route::get('/notebook', ['as'=>'notebook.index', 'uses'=>'NotebooksController@index']);
		...
		Route::get('notes/{notebbokId}/createNote', 'NotesController@createNote')->name('notes.createNote');
});
